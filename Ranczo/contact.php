...
<html>
	<head>
<title>Kontakt - Ranczo pod pomarańczą</title>
		<meta charset="utf-8">
		...
		<link href="https://fonts.googleapis.com/css?family=Smokum|Caveat" rel="stylesheet">
		...
		<div id="main-container" class="container-fluid">
			...
			<nav>
				<div class="row justify-content-center d-none d-lg-flex pb-0">
					<ul class="nav nav-tabs border-0">
						...
						<li class="nav-item"><a href="#" class="nav-link px-5 mx-2 bg-light text-dark">Kontakt</a></li>
					</ul>
				</div>
				...
				<div class="row bg-transparent navbar navbar-light d-lg-none">
					...
					<div class="collapse navbar-collapse" id="small-menu">
						<ul class="navbar-nav nav-pills">
							...
							<li class="nav-item"><a href="#" class="nav-link px-5 mx-3 bg-light text-dark">Kontakt</a></li>
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-10 bg-light jumbotron">
					<section><h3 class="text-secondary">KONTAKT</h3></section>
					
					<article class="text-dark">
						<a class="btn btn-outline-dark rounded p-2 mb-1" href="mailto:info@ranczopp.com"><i class="fas fa-envelope"></i>&nbsp;info@ranczopp.com</a>
						<a class="btn btn-outline-dark rounded p-2 mb-1" href="tel:+48-793-77-37-99"><i class="fas fa-phone-square"></i>&nbsp;PL: (+48) 793 77 37 99</a>
						<a class="btn btn-outline-dark rounded p-2 mb-1" href="tel:+49-162-677-78-88"><i class="fas fa-phone-square"></i>&nbsp;DE: (+49) 162 677 78 88</a>
						<a class="btn btn-outline-dark rounded p-2 mb-1" href="#"><i class="fas fa-map-marked"></i>&nbsp;Polany 5 A, 33-380 Krynica Zdrój</a>
						<a class="btn btn-outline-dark rounded p-2 mb-1" href="#">NR. RACHUNKU BANKOWEGO: <br class="d-xs-block d-md-none">57 1470 0002 2106 2786 7141 0001</a>
						<div class="border-1 px-1 pt-1 bg-warning mx-auto">
							<iframe class="mx-auto w-100" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2589.9796980500223!2d20.98831821569799!3d49.52265897935802!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x473ddc7318c3d9e3%3A0x4cb4d9eb336ac0cf!2sPolany+5A%2C+33-380+Polany!5e0!3m2!1spl!2spl!4v1537984550565" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
						</div>
					</article>
