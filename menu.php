...
<footer>
	...
	<div style="width: 100%;animation: showthis forwards; animation-delay: 3s;z-index: 10;background: black;color: white;position: relative;top: 0;left: -100%;">
		...
		<span id="footer-brands-icons"><span class="mid-big">HTML5 </span><i class="fab fa-html5"></i> <span class="mid-big">CSS3 </span><i class="fab fa-css3"></i> <span class="mid-big">PHP </span><i class="fab fa-php"></i> <span class="mid-big">Font Awesome </span><i class="fab fa-font-awesome"></i> <span class="mid-big">MySQL </span><?php include 'svg/database-upload.html';?> <span class="mid-big">JavaScript </span><i class="fab fa-js"></i> <span class="mid-big">Bootstrap</span><img src="../images/bootstrap.png"><span class="mid-big"> Podziękowania dla: Borsoft, P. Paprzycki</span></span>
