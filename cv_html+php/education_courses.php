<?php
//PLIK DO POBRANIA ZAWARTOŚCI ANALOGICZNEGO PLIKU Z CSS DOS - EDUCATION_COURSES.HTML
if ($_SERVER['DOCUMENT_ROOT']=="C:/Users/Lenovo/OneDrive") $path=$_SERVER['DOCUMENT_ROOT']."/littledigits.pl/cv/cv_html/education_courses.html";
else $path=$_SERVER['DOCUMENT_ROOT']."/littledigits.pl/cv/cv_html/education_courses.html";
