<?php
//PLIK DO POBRANIA ZAWARTOŚCI ANALOGICZNEGO PLIKU Z CSS DOS - LITERATURE.HTML
if ($_SERVER['DOCUMENT_ROOT']=="C:/Users/Lenovo/OneDrive") $path=$_SERVER['DOCUMENT_ROOT']."/littledigits.pl/cv/cv_html/literature.html";
else $path=$_SERVER['DOCUMENT_ROOT']."/littledigits.pl/cv/cv_html/literature.html";
