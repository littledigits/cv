<?php
//PLIK DO POBRANIA ZAWARTOŚCI ANALOGICZNEGO PLIKU Z CSS DOS - INDEX.HTML
if ($_SERVER['DOCUMENT_ROOT']=="C:/Users/Lenovo/OneDrive") $path=$_SERVER['DOCUMENT_ROOT']."/littledigits.pl/cv/cv_html/address.html";
else $path=$_SERVER['DOCUMENT_ROOT']."/littledigits.pl/cv/cv_html/address.html";
