		...
		<div id="main-container" class="container-fluid">
			...
			<nav>
				<div class="row justify-content-center d-none d-lg-flex pb-0">
					<ul class="nav nav-tabs border-0">
						<li class="nav-item"><a href="#" class="nav-link px-5 mx-2 bg-light text-dark">O nas</a></li>
				...
				<div class="row bg-transparent navbar navbar-light d-lg-none">
					...
					<div class="collapse navbar-collapse" id="small-menu">
						<ul class="navbar-nav nav-pills">
							<li class="nav-item"><a href="#" class="nav-link px-5 mx-3 bg-light text-dark">O nas</a></li>
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-10 bg-light jumbotron">
					...
					<div class="media">
						<img class="img-thumbnail w-25 d-none d-lg-block mr-5 border-0" style="background-image: linear-gradient(-90deg, orange, white, orange);" src="img/821911a8b7cb18887ade2ad0c6526863.jpg">
						<div class="media-body my-auto">
							<p>Oferujemy Państwu wynajem domu z pięknym ogrodem w małej, pełnej uroku miejscowości Polany, oddalonej o 14 km od Uzdrowiska Krynica Zdrój. Spokój i miła atmosfera oraz liczne atrakcje okolicy, pozwolą Państwu ciekawie spędzić czas, zrelaksować się  i zachować piękne wspomnienia.</p>
							<hr>
						</div>
					</div>

					<img class="img-fluid img-thumbnail border-0 w-100 d-lg-none frame" src="img/indeks.jpeg">
					<div class="media">
						<div class="media-body my-auto">
							<p>Czekamy z radością na wszystkich, którzy chcą odpocząć od hałasu i zgiełku na łonie przyrody. Z przyjemnością przywitamy Państwa świeżo upieczonym chlebem oraz przepyszną Tartą z jabłkami, której wyjątkowy smak pozostanie naszą małą tajemnicą ... <i class="fas fa-grin"></i></p>
							<hr>
						</div>
						<img class="img-thumbnail w-25 d-none d-lg-block ml-5 border-0" style="background-image: linear-gradient(-90deg, orange, white, orange);" src="img/indeks.jpeg">
					</div>			
					<p>Zapraszamy o każdej porze roku!</p>
					<p>Wszystkie niezbędne informacje uzyskają Państwo pod numerem telefonu: <a class="btn btn-outline-dark rounded px-2 py-0" href="tel:+48-793-77-37-99">PL: (+48) 793 77 37 99</a></p>
				</div>
